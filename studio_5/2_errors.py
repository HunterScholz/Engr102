...
def you_forgot_something():
    ...
    # Your Answer: One equal sign sets a variable, two checks if variables are equal.
...
def giving_functions_the_wrong_stuff():
    ...
    my_int_2 = int("4") # What happens if we try to pass a non-number?
